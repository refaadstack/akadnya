...
<template>
  <DashboardLayout>
    ...
    <div class="container mx-auto px-4 py-8">
      <!-- Flash Messages -->
      <div v-if="$page.props.flash?.success" class="bg-[#AD7F35]/10 border border-[#AD7F35]/30 text-[#5A1B24] px-4 py-3 rounded-lg mb-6">
              ...
              <div class="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    accept="image/*"
                    id="photo-upload"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#AD7F35] focus:border-transparent"
                    required
                  />
                ...
                <button
                  ...
                  class="bg-gradient-to-r from-[#AD7F35] to-[#D8BA82] text-white px-6 py-2 rounded-lg font-semibold hover:shadow-lg transition disabled:opacity-50"
                >
                ...
                <div class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-50 transition flex items-center justify-center">
                  <div class="opacity-0 group-hover:opacity-100 transition space-x-2">
                    <button
                      ...
                      class="bg-[#5A1B24] text-white p-2 rounded-lg hover:bg-[#5A1B24]/80 transition"
                      title="Edit caption"
                    >
        ...
        <form @submit.prevent="saveCaption(editingCaption)">
          ...
          <div class="flex items-center space-x-3">
            <button
              ...
              class="flex-1 bg-[#AD7F35] text-white px-4 py-2 rounded-lg font-semibold hover:bg-[#9f6b61] transition disabled:opacity-50"
            >
