  ...
  <div class="my-page">
    ...
    <main class="pt-28">
      ...
      <section class="my-container pb-20">
        <div v-if="templates.length > 0" class="grid grid-cols-1 gap-7 md:grid-cols-2 lg:grid-cols-3">
          <article
            v-for="template in templates"
            :key="template.id"
            class="my-card group overflow-hidden p-3 transition duration-300 hover:-translate-y-1"
          >
            <div class="relative overflow-hidden rounded-lg bg-[var(--my-surface-soft)]">
              <img
              ...
              <div
                ...
                class="absolute top-4 right-4 rounded-full bg-[var(--my-primary)] px-3 py-1 text-xs font-bold uppercase tracking-[0.12em] text-white"
              >
                Gratis
              </div>
            </div>
            ...
            <div class="p-4">
              ...
              <div class="mt-6 grid gap-3">
                ...
                >
                  ...
                  {{ addingToCart === template.id ? 'Memproses...' : 'Pilih Template Ini' }}
                </button>
              </div>
            </div>
          </article>
        ...
        <div v-else class="my-card py-16 text-center">
          <p class="my-heading text-3xl">Belum ada template tersedia</p>
          <p class="my-copy mx-auto mt-3 max-w-md">Template akan muncul di sini setelah diupload dari admin.</p>
          <Link href="/" class="my-btn-primary mt-6">Kembali ke Beranda</Link>
        </div>
      </section>
    </main>
