        ...
        <div class="flex items-center justify-between h-16">
          ...
          <div class="hidden md:flex items-center space-x-6">
            <Link
              ...
              :class="{ 'text-pink-600': $page.url === '/dashboard' }"
            >
              Dashboard
            </Link>
            <Link
              ...
              class="text-gray-700 hover:text-pink-600 font-medium transition"
              :class="{ 'text-pink-600': $page.url.startsWith('/dashboard/editor') }"
            >
              Editor
            </Link>
            <Link
              ...
              class="text-gray-700 hover:text-pink-600 font-medium transition"
              :class="{ 'text-pink-600': $page.url.startsWith('/dashboard/customize') }"
            >
              Kustomisasi
            </Link>
            <Link
              ...
              class="text-gray-700 hover:text-pink-600 font-medium transition"
              :class="{ 'text-pink-600': $page.url.startsWith('/dashboard/gallery') }"
            >
              Galeri
            </Link>
            <Link
              ...
              class="text-gray-700 hover:text-pink-600 font-medium transition"
              :class="{ 'text-pink-600': $page.url.startsWith('/dashboard/guests') }"
            >
              Tamu
            </Link>
            <Link
              href="/dashboard/rsvp"
              class="text-gray-700 hover:text-pink-600 font-medium transition"
              :class="{ 'text-pink-600': $page.url.startsWith('/dashboard/rsvp') }"
            >
              RSVP
            </Link>
          </div>
