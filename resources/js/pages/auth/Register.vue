                ...
                <div class="mt-8 grid max-w-md gap-4">
                    <div class="my-card flex gap-4 p-5">
                        ...
                        <p class="text-[var(--my-muted)]">
                            Template premium bisa langsung dipakai setelah
                            checkout.
                        </p>
                    </div>
                    <div class="my-card flex gap-4 p-5">
                        ...
                        />
                        <p class="text-[var(--my-muted)]">
                            Editor, RSVP, galeri, dan amplop digital tersedia di
                            dashboard.
                        </p>
                    </div>
                </div>
                ...
                <div class="my-card p-7 md:p-8">
                    <div class="mb-8 text-center">
                        ...
                        <p class="mt-2 text-[var(--my-muted)]">
                            Mulai kelola undangan digital pertamamu.
                        </p>
                    </div>
                    ...
                    <form class="grid gap-5" @submit.prevent="submit">
                        ...
                        <div>
                            <label
                                class="flex items-start gap-3 text-sm text-[var(--my-muted)]"
                            >
                                <input
                                    v-model="form.terms"
                                    type="checkbox"
                                    required
                                    class="mt-1 size-4 rounded border-[var(--my-border)] text-[var(--my-primary)] focus:ring-[var(--my-primary)]"
                                />
                                <span>
