        ...
        <div class="container mx-auto space-y-6 px-4 py-8">
            ...
            <section class="grid gap-4 sm:grid-cols-3">
                ...
                >
                    ...
                    <p class="mt-1 text-xs text-[var(--my-muted)]">
                        tamu sudah check-in
                    </p>
                </article>
                <article
            ...
            <section class="grid gap-6 lg:grid-cols-3">
                ...
                >
                    ...
                    <form @submit.prevent="submitCheckIn">
                        <label
                            class="mb-1 block text-sm font-medium text-[var(--my-neutral)]"
                            >Kode Tamu</label
                        >
                        <input
                    ...
                    <div class="mt-6 border-t border-[var(--my-border)] pt-6">
                        ...
                        <p
                            v-if="stats.checked_in === 0"
                            class="mt-2 text-xs text-[var(--my-muted)]"
                        >
