# Styling Patterns - Betawi Heritage

## 🎨 Visual Reference Guide

Panduan visual untuk semua pattern styling yang digunakan di template Betawi Heritage.
...
<div class="bg-white rounded-2xl shadow-xl p-8 border-2 border-[#fbbf24]">
  <h3 class="text-2xl font-bold text-[#dc2626] mb-4">Title</h3>
...
- Icon: Font Awesome with gap-2

### Secondary Button (Copy)
```html
<button class="copy-button inline-flex items-center gap-2 px-6 py-3 bg-[#dc2626] text-white rounded-full hover:bg-[#b91c1c] transition-all shadow-lg" data-copy="text">
